		...
		<div className="flex flex-col gap-2 px-3 py-6">
			...
			<Dialog.Root>
				...
				<Dialog.Portal>
					...
					<Dialog.Content className="max-w-md bg-white rounded-lg absolute top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 w-full px-4 py-5">
						<div className="flex items-start gap-4">
							<div className="bg-slate-100 size-9 rounded-md shrink-0 flex items-center justify-center">
								<Trash2 className="stroke-zinc-600" />
							</div>
							<div>
								<Dialog.Title className="font-semibold mb-2">
									Delete Note
								</Dialog.Title>
								<Dialog.Description className="text-sm text-zinc-700">
				...
				<Dialog.Root>
					...
					<Dialog.Portal>
						...
						<Dialog.Content className="max-w-md bg-white rounded-lg absolute top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 w-full px-4 py-5">
							<div className="flex items-start gap-4">
								<div className="bg-slate-100 size-9 rounded-md shrink-0 flex items-center justify-center">
									<Archive className="stroke-zinc-600" />
								</div>
								<div>
									<Dialog.Title className="font-semibold mb-2">
										Restore Note
